...
export const ring: Config = {
  ...
  ringColor: t.colors("--style-ring-color"),
  ringOffset: t.prop("--style-ring-offset-width"),
  ringOffsetColor: t.colors("--style-ring-offset-color"),
  ringInset: t.prop("--style-ring-inset"),
}
